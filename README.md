...
Install from this repo master / production branches, or head to the [Chrome Web Store](https://chrome.google.com/webstore/detail/ggjfmmgmhdopapbclggmlhjdepljpmha) to install a version that benefits from automatic updates.
