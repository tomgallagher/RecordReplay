...
(function() {
    ...
    var CssSelectorGenerator, root, __indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; };
  
    CssSelectorGenerator = (function() {
      
        CssSelectorGenerator.prototype.default_options = { selectors: ['tag', 'id', 'class', 'nthchild'] };
        ...
        CssSelectorGenerator.prototype.validateId = function(id) {
            ...
            if (/^\d/.exec(id)) { return false; }
        
            if (document.querySelectorAll("#" + id).length !== 1) { return false; }
        ...
        CssSelectorGenerator.prototype.getIdSelector = function(element) {
            ...
            if (id != null) { id = this.sanitizeItem(id); }
