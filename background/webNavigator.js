class WebNavigator {
    ...
    constructor() {
        ...
        this.monitoredEventsObservables = this.monitoredEvents.map(eventName => Rx.Observable.fromEventPattern(
            ...
            handler => {
                ...
                const wrapper = webNavigationEvent => {
                    ...
                    const recordReplayWebNavigationEvent = Object.assign({}, webNavigationEvent, {recordReplayWebNavigationEvent: eventName})
        ...
        this.navigationEventsObservable = Rx.Observable.merge(...this.monitoredEventsObservables);
    }
