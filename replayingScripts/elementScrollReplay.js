class ElementScrollReplay {
     ...
     actionFunction = () => {
        ...
        return new Promise(resolve => {
            ...
            setTimeout( () => {
                ...
                document.querySelector(this.chosenSelectorReport.selectorString).scrollTo({left: this.scrollX, top: this.scrollY, behavior: 'smooth'}); 
    ...
    //at the moment we are only collecting scrolls on the main document, so there is no need to find the element
    returnPlayBackObservable = () => Rx.Observable.fromEvent(document.querySelector(this.chosenSelectorReport.selectorString), "scroll")
